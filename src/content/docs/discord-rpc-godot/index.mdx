...
import { Content as LastQuickSteps } from "../../reusables/last_quick_steps.mdx";
...
<Tabs>
  ...
  <TabItem label="Manual">
    <Steps>
      <ol>
        <li>
          [Download the addon](https://github.com/vaporvee/discord-rpc-godot/releases/latest/download/ADDON-discord-rpc-godot.zip/)
        </li>
        <li>
		Put the folder from the zip file in the root of your Godot project like the following
		<FileTree>
		- **addons/**
		  - discord-rpc-gd/
		    - bin/
...
[**Try a built demo**](https://github.com/vaporvee/discord-rpc-godot/releases/latest/download/Demo-Export.zip)<br />
## Troubleshooting
